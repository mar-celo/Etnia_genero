...
sd_ind3 <- SharedData$new(Tab_ind3, group = "necessidade")
...
sd_ind4 <- SharedData$new(Tab_ind4_orgaos, group = "funcao")
...
sd_ind5 <- SharedData$new(Tab_ind5_orgaos, group = "funcao")

```


# **Indicadores 1 e 2: Participação de pessoas negras em cargos CCE/FCE (níveis 1 a 12 e níveis 13 a 17)**
...
# **Indicador 3: Índice de suficiência de vagas para cumprimento da meta racial**
...
# **Indicador 4: Índice de equidade de acesso a cargos FCE (raça e gênero) **
...
#  **Indicador 5: :razão entre remuneração média dos CCEs e FCEs negros em relação á observada entre os brancos**
