...
data_funcao <- dados |> select(`Natureza Jurídica`,
                               `Órgão Superior`,
                               Órgão, Etnia , `Cargo-Função`, Fem, Mas, Total) |> 
...
trace1 <- list(
  ...
  text = paste(df_tela_inicial_1a12$`% Nível 1 a 12`, "%", "(",df_tela_inicial_1a12$`Nível 1 a 12`,")"),
...
trace1 <- list(
  ...
  width = 0.5, 
  marker = list(color = "#004580"), 
  text = paste(df_tela_inicial_13a17$`% Nível 13 a 17`, "%", "(",df_tela_inicial_13a17$`Nível 13 a 17`,")"),
  textfont = list(color = "white"), 
  orientation = "h", 
  textposition = "inside"
)
...
bscols(ranking_1_a_12, ranking_13_a_17,
       filtro_Orgao,
       figpier_Nivel1a12,
       figpier_Nivel13a17,
       widths = c(  6,6,12, 6,6),
